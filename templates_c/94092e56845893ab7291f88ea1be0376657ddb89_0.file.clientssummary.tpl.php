...
: <span id="taxstatus" class="csajaxtoggle"
                                                                style="text-decoration:underline;cursor:pointer"><strong
                        class="<?php if ($_smarty_tpl->tpl_vars['clientsdetails']->value['taxstatus'] == "Yes") {?>textgreen<?php } else { ?>textred<?php }?>"><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['taxstatus'];?>
</strong></span>
            &nbsp;&nbsp;
            <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['settingautocc'];?>
: <span id="autocc" class="csajaxtoggle"
                                                             style="text-decoration:underline;cursor:pointer"><strong
                        class="<?php if ($_smarty_tpl->tpl_vars['clientsdetails']->value['autocc'] == "Yes") {?>textgreen<?php } else { ?>textred<?php }?>"><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['autocc'];?>
</strong></span>
            &nbsp;&nbsp;
            <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['settingreminders'];?>
: <span id="overduenotices" class="csajaxtoggle"
                                                                style="text-decoration:underline;cursor:pointer"><strong
                        class="<?php if ($_smarty_tpl->tpl_vars['clientsdetails']->value['overduenotices'] == "Yes") {?>textgreen<?php } else { ?>textred<?php }?>"><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['overduenotices'];?>
</strong></span>
            &nbsp;&nbsp;
            <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['settinglatefees'];?>
: <span id="latefees" class="csajaxtoggle"
                                                               style="text-decoration:underline;cursor:pointer"><strong
                        class="<?php if ($_smarty_tpl->tpl_vars['clientsdetails']->value['latefees'] == "Yes") {?>textgreen<?php } else { ?>textred<?php }?>"><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['latefees'];?>
</strong></span>
        </div>
            ...
            <div class="verification-banner email-verification alert-warning" role="alert">
                ...
                <div class="pull-right">
                    <button id="btnResendVerificationEmail" class="btn btn-default btn-sm"
                            data-clientid="<?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['userid'];?>
        ...
        <div class="col-lg-3 col-sm-6">
            ...
            <div class="clientssummarybox">
                ...
                <table class="clientssummarystats" cellspacing="0" cellpadding="2">
                    <tr>
                        <td width="110"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['fields']['firstname'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['firstname'];?>
</td>
                    </tr>
                    <tr class="altrow">
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['fields']['lastname'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['lastname'];?>
</td>
                    </tr>
                    <tr>
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['fields']['companyname'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['companyname'];?>
</td>
                    </tr>
                    <tr class="altrow">
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['fields']['email'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['email'];?>
</td>
                    </tr>
                    <tr>
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['fields']['address1'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['address1'];?>
</td>
                    </tr>
                    <tr class="altrow">
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['fields']['address2'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['address2'];?>
</td>
                    </tr>
                    <tr>
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['fields']['city'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['city'];?>
</td>
                    </tr>
                    <tr class="altrow">
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['fields']['state'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['state'];?>
</td>
                    </tr>
                    <tr>
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['fields']['postcode'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['postcode'];?>
</td>
                    </tr>
                    <tr class="altrow">
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['fields']['country'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['country'];?>
 - <?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['countrylong'];?>
</td>
                    </tr>
                    <tr>
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['fields']['phonenumber'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['phonenumber'];?>
</td>
                    </tr>
                ...
                <ul>
                    <li>
                        <a id="summary-login-as-owner" class="summary-login-as-owner" data-new-window="0" href="#"><img
                                    src="images/icons/clientlogin.png" border="0"
                                    align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['loginasowner'];?>
</a>
                        <a id="summary-login-as-owner-new-window" class="summary-login-as-owner" data-new-window="1"
                           href="#" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['lang'][0], array( array('key'=>'global.openInNewWindow'),$_smarty_tpl ) );?>
">
...
">
                            <td align="center"><a
                                        href="clientscontacts.php?userid=<?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['userid'];?>
...
?>
                        <tr>
                            <td align="center"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['nocontacts'];?>
</td>
                        </tr>
                    <?php
}
...
&contactid=addnew"><img
                                    src="images/icons/clientsadd.png" border="0"
                                    align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clients']['addcontact'];?>
</a></li>
                </ul>
            </div>
 ...
 (<?php echo $_smarty_tpl->tpl_vars['stats']->value['collectionsinvoicesamount'];?>
                ...
                <ul>
                    <?php if (in_array('Create Invoice',$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>
                        <li>
                            <a href="invoices.php?action=createinvoice&userid=<?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['userid'];?>
&token=<?php echo $_smarty_tpl->tpl_vars['csrfToken']->value;?>
"><img
                                        src="images/icons/invoicesedit.png" border="0"
                                        align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['invoices']['create'];?>
</a></li>
                    <?php }?>
                    <?php if (in_array('Create Add Funds Invoice',$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>
                        <li><a href="#" data-toggle="modal" data-target="#modalAddFunds"><img
                                        src="images/icons/addfunds.png" border="0"
                                        align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['createaddfunds'];?>
</a></li>
                    <?php }?>
                    <?php if (in_array('Generate Due Invoices',$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>
                        <li><a href="#" data-toggle="modal" data-target="#modalGenerateInvoices"><img
                                        src="images/icons/ticketspredefined.png" border="0"
                                        align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['invoices']['geninvoices'];?>
</a></li>
                    <?php }?>
                    <li><a href="clientsbillableitems.php?userid=<?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['userid'];?>
&action=manage"><img
                                    src="images/icons/billableitems.png" border="0"
                                    align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['billableitems']['additem'];?>
</a></li>
                    <li><a href="#" id="manageCredits"
                           onClick="window.open('clientscredits.php?userid=<?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['userid'];?>
','','width=800,height=350,scrollbars=yes');return false"><img
                                    src="images/icons/income.png" border="0"
                                    align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['managecredits'];?>
</a></li>
                    <li><a href="quotes.php?action=manage&userid=<?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['userid'];?>
"><img
                                    src="images/icons/quotes.png" border="0"
                                    align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['quotes']['createnew'];?>
</a></li>
                </ul>
            </div>
            ...
            <div class="clientssummarybox">
                ...
                <table class="clientssummarystats" cellspacing="0" cellpadding="2">
                    <tr>
                        <td width="110"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['fields']['status'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['status'];?>
</td>
                    </tr>
                    <tr class="altrow">
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['fields']['clientgroup'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['clientgroup']->value['name'];?>
</td>
                    </tr>
                    <tr>
                    ...
                    <tr class="altrow">
                        ...
                        <td><?php echo $_smarty_tpl->tpl_vars['clientfor']->value;?>
</td>
                    </tr>

                    <tr>
                        <td width="110"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['lastlogin'];?>
</td>

                        <td><?php if (preg_match('/([0-9]{2})\:([0-9]{2}+)/m',$_smarty_tpl->tpl_vars['lastlogin']->value)) {
echo preg_match_all('/([0-9]{2})\:([0-9]{2}+)/m',$_smarty_tpl->tpl_vars['lastlogin']->value,$_smarty_tpl->tpl_vars['m']->value);?>

                               Time: <?php echo $_smarty_tpl->tpl_vars['m']->value[0][0];?>

                            <?php }
echo smarty_modifier_regex_replace($_smarty_tpl->tpl_vars['lastlogin']->value,'/([0-9]{4})\/([0-9]{2})\/([0-9]{2})\ ([0-9]{2})\:([0-9]{2}+)/m',Morilog\Jalali\CalendarUtils::strftime('Y-m-d',strtotime($_smarty_tpl->tpl_vars['lastlogin']->value)));?>
</td>
                    </tr>
                    <?php if ($_smarty_tpl->tpl_vars['emailVerificationEnabled']->value) {?>
                        <tr class="altrow">
                            <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['fields']['emailverified'];?>
</td>
                            <td><?php if ($_smarty_tpl->tpl_vars['emailVerified']->value) {
...
echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['global']['no'];
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="clientssummarybox">
                ...
                <table class="clientssummarystats" cellspacing="0" cellpadding="2">
                    <tr>
                        <td width="140"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['orders']['sharedhosting'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['stats']->value['productsnumactivehosting'];?>
 (<?php echo $_smarty_tpl->tpl_vars['stats']->value['productsnumhosting'];?>
 Total)</td>
                    </tr>
                    <tr class="altrow">
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['orders']['resellerhosting'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['stats']->value['productsnumactivereseller'];?>
 (<?php echo $_smarty_tpl->tpl_vars['stats']->value['productsnumreseller'];?>
 Total)</td>
                    </tr>
                    <tr>
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['orders']['server'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['stats']->value['productsnumactiveservers'];?>
 (<?php echo $_smarty_tpl->tpl_vars['stats']->value['productsnumservers'];?>
 Total)</td>
                    </tr>
                    <tr class="altrow">
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['orders']['other'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['stats']->value['productsnumactiveother'];?>
 (<?php echo $_smarty_tpl->tpl_vars['stats']->value['productsnumother'];?>
 Total)</td>
                    </tr>
                    <tr>
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['domains']['title'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['stats']->value['numactivedomains'];?>
 (<?php echo $_smarty_tpl->tpl_vars['stats']->value['numdomains'];?>
 Total)</td>
                    </tr>
                    <tr class="altrow">
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['stats']['acceptedquotes'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['stats']->value['numacceptedquotes'];?>
 (<?php echo $_smarty_tpl->tpl_vars['stats']->value['numquotes'];?>
 Total)</td>
                    </tr>
                    <tr>
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['support']['supporttickets'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['stats']->value['numactivetickets'];?>
 (<?php echo $_smarty_tpl->tpl_vars['stats']->value['numtickets'];?>
 Total)</td>
                    </tr>
                    <tr class="altrow">
                        <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['stats']['affiliatesignups'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['stats']->value['numaffiliatesignups'];?>
</td>
                    </tr>
                </table>
                <ul>
...
"><img src="images/icons/orders.png"
                                                                                    border="0"
                                                                                    align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['vieworders'];?>

                        </a></li>
                    <li><a href="ordersadd.php?userid=<?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['userid'];?>
"><img src="images/icons/ordersadd.png"
                                                                                     border="0"
                                                                                     align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['orders']['addnew'];?>
...
"><i
                                            class="far fa-file"></i> <?php echo $_smarty_tpl->tpl_vars['file']->value['title'];?>
                                        ...
                                        src="images/icons/delete.png" align="absmiddle" border="0"
...
?>
                        <tr>
                            <td align="center"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['nofiles'];?>
</td>
                        </tr>
                    <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                ...
                <ul>
                    <li><a href="#" id="addfile"><img src="images/icons/add.png" border="0"
                                                      align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['fileadd'];?>
</a></li>
                </ul>
...
&action=uploadfile"
                        ...
                        <table class="clientssummarystats" cellspacing="0" cellpadding="2">
                            <tr>
                                <td width="40"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['filetitle'];?>
</td>
                                <td class="fieldarea"><input type="text" name="title" style="width:90%"/></td>
                            </tr>
                            <tr>
                                <td><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['filename'];?>
</td>
                                <td class="fieldarea"><input type="file" name="uploadfile" style="width:90%"/>
                                    <p class="text-muted">
                            ...
                            <tr>
                                <td></td>
                                <td class="fieldarea"><input type="checkbox" name="adminonly"
                                                             value="1"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['fileadminonly'];?>
...
?>
                        <tr>
                            <td align="center"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['noemails'];?>
</td>
                        </tr>
                    <?php
}
...
"><img
                                    ...
                                    align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['accountstatement'];?>
</a></li>
                    <li><a href="supporttickets.php?action=open&userid=<?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['userid'];?>
"><img
                                    src="images/icons/ticketsopen.png" border="0"
                                    align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['newticket'];?>
</a></li>
                    <li><a href="supporttickets.php?view=any&client=<?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['userid'];?>
"><img
                                    src="images/icons/ticketsother.png" border="0"
                                    align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['viewtickets'];?>
</a></li>
                    <li>
                        <a href="<?php if ($_smarty_tpl->tpl_vars['affiliateid']->value) {?>affiliates.php?action=edit&id=<?php echo $_smarty_tpl->tpl_vars['affiliateid']->value;
...
&activateaffiliate=true&token=<?php echo $_smarty_tpl->tpl_vars['csrfToken']->value;
                                    ...
                                    src="images/icons/affiliates.png" border="0"
                                    align="absmiddle"/> <?php if ($_smarty_tpl->tpl_vars['affiliateid']->value) {
...
" class="open-modal"
                           data-modal-title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['lang'][0], array( array('key'=>'clients.mergeclient'),$_smarty_tpl ) );?>
" data-btn-submit-id="btnMerge"
                           data-btn-submit-label="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['lang'][0], array( array('key'=>'invoices.merge'),$_smarty_tpl ) );?>
">
                            <img src="images/icons/clients.png" border="0"
                                 align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['mergeclients'];?>

                        </a>
                    </li>
                    <li><a href="#" onClick="closeClient();return false" style="color:#000000;"><img
                                    src="images/icons/delete.png" border="0"
                                    align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['closeclient'];?>
</a></li>
                    <li><a id="btnDeleteClient" href="#" style="color:#CC0000;"><img src="images/icons/delete.png"
                                                                                     border="0"
                                                                                     align="absmiddle"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['deleteclient'];?>
...
&action=savenotes">
                    <div align="center">
                        <textarea name="adminnotes" rows="5"
                                  class="form-control bottom-margin-5"><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['notes'];?>
</textarea>
                        <input type="submit" value="<?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['global']['submit'];?>
" class="button btn btn-default"/>
    ...
    <p align="right">
        <button id="btnStatusEnabled" type="button" value="filter" class="btn btn-xs btn-small"
...
: <span class="on"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['lang'][0], array( array('key'=>'global.on'),$_smarty_tpl ) );?>
                    ...
                    class="off"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['lang'][0], array( array('key'=>'global.off'),$_smarty_tpl ) );?>
</span>
        </button>
    </p>
    <div id="statusfilter">
        <form>
            <div class="checkall">
                <label class="checkbox-inline"><input type="checkbox" id="statusfiltercheckall"
                                                      checked="checked"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['global']['checkall'];?>
</label>
            </div>
...
?>
                    <tr>
                        <td><label class="checkbox-inline" style="display:block;"><input type="checkbox"
                                                                                         name="statusfilter[]"
                                                                                         value="<?php echo $_smarty_tpl->tpl_vars['itemstatus']->value;?>
"
                                                                                         onclick="uncheckCheckAllStatusFilter()"
                                                                                         checked="checked"/> <?php echo $_smarty_tpl->tpl_vars['statuslang']->value;?>
...
" class="btn btn-xs btn-small btn-primary"
                       onclick="applyStatusFilter();toggleStatusFilter();return false;"/>
            </div>
        </form>
    </div>
...
&action=massaction">
        ...
        <table width="100%" class="form">
            <tr>
                <td colspan="2" class="fieldarea" style="text-align:center;">
                    <strong><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['services']['title'];?>
</strong></td>
            </tr>
            <tr>
                <td align="center">
...
"
                                               class="checkprods"/></td>
                                    <td>
                                        <a href="clientsservices.php?userid=<?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['userid'];?>
...
"><?php echo $_smarty_tpl->tpl_vars['product']->value['idshort'];?>
 ...
 - <a
                                                href="<?php echo $_smarty_tpl->tpl_vars['product']->value['domainLink'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <table width="100%" class="form">
            <tr>
                <td colspan="2" class="fieldarea" style="text-align:center;"><strong><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['addons']['title'];?>
</strong>
                </td>
            </tr>
            <tr>
...
if ($_smarty_tpl->tpl_vars['addon']->do_else) {
?>
                                <tr>
                                    <td colspan="9"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['global']['norecordsfound'];?>
</td>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <table width="100%" class="form">
            <tr>
                <td colspan="2" class="fieldarea" style="text-align:center;">
                    <strong><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['domains']['title'];?>
</strong></td>
            </tr>
            <tr>
                <td align="center">
...
"
                                    ...
                                    <td>
                                        <a href="clientsdomains.php?userid=<?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['userid'];?>
...
echo Morilog\Jalali\CalendarUtils::strftime('Y-m-d',$_smarty_tpl->tpl_vars['domain']->value['expirydate']);
                                    ...
                                    <td class="status"
                                        data-filter-value="<?php echo $_smarty_tpl->tpl_vars['domain']->value['originalstatus'];?>
...
if ($_smarty_tpl->tpl_vars['domain']->do_else) {
?>
                                <tr>
                                    <td colspan="9"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['global']['norecordsfound'];?>
</td>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <table width="100%" class="form">
            <tr>
                <td colspan="2" class="fieldarea" style="text-align:center;">
                    <strong><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['currentquotes'];?>
</strong></td>
            </tr>
            <tr>
                <td align="center">
...
if ($_smarty_tpl->tpl_vars['quote']->do_else) {
?>
                                <tr>
        ...
        <div class="bulk-actions">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-lg-push-9 col-sm-6 text-right">
                    <button id="massUpdateItems" type="button" class="btn btn-link"
                            onclick="$('#bulkUpdateAdvancedOptions').slideToggle()">
                            ...
                            <div class="form-group">
                                <div class="form-group date-picker-prepend-icon">
                                    ...
                                    <input type="text" name="overidesuspenduntil"
                                           class="form-control date-picker-single future" data-drops="up"
                    ...
                    <tr>
                        ...
                        <td class="fieldarea">
                            <div class="form-group date-picker-prepend-icon">
                                ...
                                <input type="text" id="nextDueDate" name="nextduedate"
                                       class="input-inline form-control date-picker-single future" data-drops="up"
                                       data-original-value="" value=""/>
                                &nbsp;&nbsp; <input type="checkbox" name="proratabill"
                                                    id="proratabill"/> <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clientsummary']['createproratainvoice'];?>
...
"
                                   class="button btn btn-default"/>
                            <input type="submit" name="masschangepackage"
                                   value="<?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['modulebuttons']['changepackage'];?>
" class="button btn btn-default"/>

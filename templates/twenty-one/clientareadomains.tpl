                ...
                <table id="tableDomainsList" class="table table-list w-hidden">
                    ...
                    {foreach $domains as $domain}
                        <tr onclick="clickableSafeRedirect(event, 'clientarea.php?action=domaindetails&amp;id={$domain.id}', false)">
                            ...
                            <td><span class="w-hidden">{$domain.normalisedRegistrationDate}</span>{Morilog\Jalali\CalendarUtils::strftime('Y-m-d',  $domain.normalisedRegistrationDate)}</td>
                            <td><span class="w-hidden">{$domain.normalisedNextDueDate}</span>{Morilog\Jalali\CalendarUtils::strftime('Y-m-d', $domain.normalisedNextDueDate)}</td>
                            <td>

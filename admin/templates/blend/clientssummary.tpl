<div id="clientsummarycontainer">
    ...
    <div class="clearfix">
        ...
        <div class="clientsummaryactions">
            {$_ADMINLANG.clientsummary.settingtaxexempt}: <span id="taxstatus" class="csajaxtoggle"
                                                                style="text-decoration:underline;cursor:pointer"><strong
                        class="{if $clientsdetails.taxstatus == "Yes"}textgreen{else}textred{/if}">{$clientsdetails.taxstatus}</strong></span>
            &nbsp;&nbsp;
            {$_ADMINLANG.clientsummary.settingautocc}: <span id="autocc" class="csajaxtoggle"
                                                             style="text-decoration:underline;cursor:pointer"><strong
                        class="{if $clientsdetails.autocc == "Yes"}textgreen{else}textred{/if}">{$clientsdetails.autocc}</strong></span>
            &nbsp;&nbsp;
            {$_ADMINLANG.clientsummary.settingreminders}: <span id="overduenotices" class="csajaxtoggle"
                                                                style="text-decoration:underline;cursor:pointer"><strong
                        class="{if $clientsdetails.overduenotices == "Yes"}textgreen{else}textred{/if}">{$clientsdetails.overduenotices}</strong></span>
            &nbsp;&nbsp;
            {$_ADMINLANG.clientsummary.settinglatefees}: <span id="latefees" class="csajaxtoggle"
                                                               style="text-decoration:underline;cursor:pointer"><strong
                        class="{if $clientsdetails.latefees == "Yes"}textgreen{else}textred{/if}">{$clientsdetails.latefees}</strong></span>
        </div>
            ...
            <div class="verification-banner email-verification alert-warning" role="alert">
                ...
                <div class="pull-right">
                    <button id="btnResendVerificationEmail" class="btn btn-default btn-sm"
                            data-clientid="{$clientsdetails.userid}" data-successmsg="{$_ADMINLANG.global.emailSent}"
                            data-errormsg="{$_ADMINLANG.global.erroroccurred}">
    ...
    <div class="row client-summary-panels">
        <div class="col-lg-3 col-sm-6">
                ...
                <ul>
                    <li>
                        <a id="summary-login-as-owner" class="summary-login-as-owner" data-new-window="0" href="#"><img
                                    ...
                                    align="absmiddle"/> {$_ADMINLANG.clientsummary.loginasowner}</a>
                        <a id="summary-login-as-owner-new-window" class="summary-login-as-owner" data-new-window="1"
                           href="#" title="{lang key='global.openInNewWindow'}">
            ...
            <div class="clientssummarybox">
                ...
                <table class="clientssummarystats" cellspacing="0" cellpadding="2">
                    {foreach key=num from=$contacts item=contact}
                        <tr class="{cycle values=",altrow"}">
                            <td align="center"><a
                                        href="clientscontacts.php?userid={$clientsdetails.userid}&contactid={$contact.id}">{$contact.firstname} {$contact.lastname}</a>
                                - {$contact.email}</td>
                        </tr>
                        {foreachelse}
                        <tr>
                ...
                <ul>
                    <li><a href="clientscontacts.php?userid={$clientsdetails.userid}&contactid=addnew"><img
                                    src="images/icons/clientsadd.png" border="0"
                                    align="absmiddle"/> {$_ADMINLANG.clients.addcontact}</a></li>
                </ul>
            </div>
            {$paymethodsSummary}
            ...
            <div class="clientssummarybox">
                ...
                <ul>
                    {if in_array('Create Invoice', $admin_perms)}
                        <li>
                            <a href="invoices.php?action=createinvoice&userid={$clientsdetails.userid}&token={$csrfToken}"><img
                                        src="images/icons/invoicesedit.png" border="0"
                                        align="absmiddle"/> {$_ADMINLANG.invoices.create}</a></li>
                    {/if}
                    {if in_array('Create Add Funds Invoice', $admin_perms)}
                        <li><a href="#" data-toggle="modal" data-target="#modalAddFunds"><img
                                        ...
                                        align="absmiddle"/> {$_ADMINLANG.clientsummary.createaddfunds}</a></li>
                    {/if}
                    {if in_array('Generate Due Invoices', $admin_perms)}
                        <li><a href="#" data-toggle="modal" data-target="#modalGenerateInvoices"><img
                                        ...
                                        align="absmiddle"/> {$_ADMINLANG.invoices.geninvoices}</a></li>
                    {/if}
                    <li><a href="clientsbillableitems.php?userid={$clientsdetails.userid}&action=manage"><img
                                    src="images/icons/billableitems.png" border="0"
                                    align="absmiddle"/> {$_ADMINLANG.billableitems.additem}</a></li>
                    <li><a href="#" id="manageCredits"
                           onClick="window.open('clientscredits.php?userid={$clientsdetails.userid}','','width=800,height=350,scrollbars=yes');return false"><img
                                    src="images/icons/income.png" border="0"
                                    align="absmiddle"/> {$_ADMINLANG.clientsummary.managecredits}</a></li>
                    <li><a href="quotes.php?action=manage&userid={$clientsdetails.userid}"><img
                                    src="images/icons/quotes.png" border="0"
                                    align="absmiddle"/> {$_ADMINLANG.quotes.createnew}</a></li>
                </ul>
            </div>
            ...
            <div class="clientssummarybox">
                ...
                <table class="clientssummarystats" cellspacing="0" cellpadding="2">
                    ...
                    <tr>
                        ...
                        <td>{if preg_match( '/([0-9]{2})\:([0-9]{2}+)/m',$lastlogin)}{preg_match_all('/([0-9]{2})\:([0-9]{2}+)/m',$lastlogin,$m)}
                               Time: {$m[0][0]}
                            {/if}{$lastlogin|regex_replace:'/([0-9]{4})\/([0-9]{2})\/([0-9]{2})\ ([0-9]{2})\:([0-9]{2}+)/m':Morilog\Jalali\CalendarUtils::strftime('Y-m-d',strtotime($lastlogin))}</td>
                    </tr>
                    {if $emailVerificationEnabled}
                        <tr class="altrow">
                            <td>{$_ADMINLANG.fields.emailverified}</td>
                            <td>{if $emailVerified}{$_ADMINLANG.global.yes}{else}{$_ADMINLANG.global.no}{/if}</td>
                        </tr>
                    {/if}
                </table>
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="clientssummarybox">
                ...
                <ul>
                    <li><a href="orders.php?clientid={$clientsdetails.userid}"><img src="images/icons/orders.png"
                                                                                    border="0"
                                                                                    align="absmiddle"/> {$_ADMINLANG.clientsummary.vieworders}
                        </a></li>
                    <li><a href="ordersadd.php?userid={$clientsdetails.userid}"><img src="images/icons/ordersadd.png"
                                                                                     border="0"
                                                                                     align="absmiddle"/> {$_ADMINLANG.orders.addnew}
                        </a></li>
                </ul>
            </div>
            ...
            <div class="clientssummarybox">
                ...
                <table class="clientssummarystats" cellspacing="0" cellpadding="2">
                    {foreach key=num from=$files item=file}
                        <tr class="{cycle values=",altrow"}">
                            <td align="center"><a href="../dl.php?type=f&id={$file.id}"><i
                                            class="far fa-file"></i> {$file.title}
                                </a> {if $file.adminonly}({$_ADMINLANG.clientsummary.fileadminonly}){/if} <img
                ...
                <ul>
                    <li><a href="#" id="addfile"><img src="images/icons/add.png" border="0"
                                                      align="absmiddle"/> {$_ADMINLANG.clientsummary.fileadd}</a></li>
                </ul>
                        ...
                        <table class="clientssummarystats" cellspacing="0" cellpadding="2">
                            ...
                            <tr>
                                ...
                                <td class="fieldarea"><input type="checkbox" name="adminonly"
                                                             value="1"/> {$_ADMINLANG.clientsummary.fileadminonly}
        ...
        <div class="col-lg-3 col-sm-6">
            ...
            <div class="clientssummarybox">
                ...
                <ul>
                    ...
                    {/foreach}
                    <li><a href="reports.php?report=client_statement&userid={$clientsdetails.userid}"><img
                                    src="images/icons/reports.png" border="0"
                                    align="absmiddle"/> {$_ADMINLANG.clientsummary.accountstatement}</a></li>
                    <li><a href="supporttickets.php?action=open&userid={$clientsdetails.userid}"><img
                                    src="images/icons/ticketsopen.png" border="0"
                                    align="absmiddle"/> {$_ADMINLANG.clientsummary.newticket}</a></li>
                    <li><a href="supporttickets.php?view=any&client={$clientsdetails.userid}"><img
                                    src="images/icons/ticketsother.png" border="0"
                                    align="absmiddle"/> {$_ADMINLANG.clientsummary.viewtickets}</a></li>
                    <li>
                        <a href="{if $affiliateid}affiliates.php?action=edit&id={$affiliateid}{else}clientssummary.php?userid={$clientsdetails.userid}&activateaffiliate=true&token={$csrfToken}{/if}"><img
                                    ...
                                    align="absmiddle"/> {if $affiliateid}{$_ADMINLANG.clientsummary.viewaffiliate}{else}{$_ADMINLANG.clientsummary.activateaffiliate}{/if}
                        </a></li>
                    <li>
                        <a href="clientsmerge.php?userid={$clientsdetails.userid}" class="open-modal"
                           data-modal-title="{lang key='clients.mergeclient'}" data-btn-submit-id="btnMerge"
                           data-btn-submit-label="{lang key='invoices.merge'}">
                            <img src="images/icons/clients.png" border="0"
                                 align="absmiddle"/> {$_ADMINLANG.clientsummary.mergeclients}
                        </a>
                    </li>
                    <li><a href="#" onClick="closeClient();return false" style="color:#000000;"><img
                                    src="images/icons/delete.png" border="0"
                                    align="absmiddle"/> {$_ADMINLANG.clientsummary.closeclient}</a></li>
                    <li><a id="btnDeleteClient" href="#" style="color:#CC0000;"><img src="images/icons/delete.png"
                                                                                     border="0"
                                                                                     align="absmiddle"/> {$_ADMINLANG.clientsummary.deleteclient}
                        </a></li>
                    <li>
            ...
            <div class="clientssummarybox">
                ...
                <form action="clientsemails.php?userid={$clientsdetails.userid}&action=send&type=general" method="post">
                    ...
                    <div align="center">{$messages} <input type="submit" value="{$_ADMINLANG.global.go}"
                ...
                <form method="post" action="{$smarty.server.PHP_SELF}?userid={$clientsdetails.userid}&action=savenotes">
                    <div align="center">
                        <textarea name="adminnotes" rows="5"
                                  class="form-control bottom-margin-5">{$clientsdetails.notes}</textarea>
    ...
    <p align="right">
        <button id="btnStatusEnabled" type="button" value="filter" class="btn btn-xs btn-small"
            ...
            {$_ADMINLANG.clientsummary.statusfilter}: <span class="on">{lang key='global.on'}</span><span
                    class="off">{lang key='global.off'}</span>
        </button>
    </p>
    <div id="statusfilter">
        <form>
            <div class="checkall">
                <label class="checkbox-inline"><input type="checkbox" id="statusfiltercheckall"
                                                      checked="checked"/> {$_ADMINLANG.global.checkall}</label>
            </div>
            ...
            <div class="applybtn">
                <input type="button" value="{$_ADMINLANG.global.apply}" class="btn btn-xs btn-small btn-primary"
    ...
    <form method="post" action="{$smarty.server.PHP_SELF}?userid={$clientsdetails.userid}&action=massaction">
        ...
        <table width="100%" class="form">
            <tr>
                <td colspan="2" class="fieldarea" style="text-align:center;">
                    <strong>{$_ADMINLANG.services.title}</strong></td>
            </tr>
            <tr>
                <td align="center">
                    ...
                    <div class="tablebg">
                        <table class="datatable filterable" width="100%" border="0" cellspacing="1" cellpadding="3">
                            ...
                            {foreach key=num from=$productsummary item=product}
                                <tr>
                                    <td><input type="checkbox" name="selproducts[]" value="{$product.id}"
                                               class="checkprods"/></td>
                                    <td>
                                        <a href="clientsservices.php?userid={$clientsdetails.userid}&id={$product.id}">{$product.idshort}</a>
                                    </td>
                                    <td style="padding-left:5px;padding-right:5px">{$product.dpackage} - <a
                                    ...
                                    <td>
                                        <a href="clientsservices.php?userid={$clientsdetails.userid}&id={$product.id}"><img
        ...
        <table width="100%" class="form">
            <tr>
                <td colspan="2" class="fieldarea" style="text-align:center;"><strong>{$_ADMINLANG.addons.title}</strong>
                </td>
            </tr>
            <tr>
                <td align="center">
                    ...
                    <div class="tablebg">
                        <table class="datatable filterable" width="100%" border="0" cellspacing="1" cellpadding="3">
                            ...
                            {foreach key=num from=$addonsummary item=addon}
                                <tr>
                                    <td><input type="checkbox" name="seladdons[]" value="{$addon.id}"
                                               class="checkaddons"/></td>
                                    <td>
                                        <a href="clientsservices.php?userid={$clientsdetails.userid}&id={$addon.serviceid}&aid={$addon.id}">{$addon.idshort}</a>
                                    </td>
                                    <td style="padding-left:5px;padding-right:5px">{$addon.addonname}
                                        <br>{$addon.dpackage} - <a href="{$addon.domainLink}"
        ...
        <table width="100%" class="form">
            <tr>
                <td colspan="2" class="fieldarea" style="text-align:center;">
                    <strong>{$_ADMINLANG.domains.title}</strong></td>
            </tr>
            <tr>
                <td align="center">
                    ...
                    <div class="tablebg">
                        <table class="datatable filterable" width="100%" border="0" cellspacing="1" cellpadding="3">
                            ...
                            {foreach key=num from=$domainsummary item=domain}
                                <tr>
                                    <td><input type="checkbox" name="seldomains[]" value="{$domain.id}"
                                               class="checkdomains"/></td>
                                    <td>
                                        <a href="clientsdomains.php?userid={$clientsdetails.userid}&domainid={$domain.id}">{$domain.idshort}</a>
                                    </td>
                                    <td style="padding-left:5px;padding-right:5px"><a href="http://{$domain.domain}"
                                    ...
                                    <td class="status"
                                        data-filter-value="{$domain.originalstatus}">{$domain.status}</td>
                                    <td>
                                        <a href="clientsdomains.php?userid={$clientsdetails.userid}&domainid={$domain.id}"><img
                                                    src="images/edit.gif" width="16" height="16" border="0" alt="Edit"></a>
                                    </td>
                                </tr>
                                {foreachelse}
        ...
        <table width="100%" class="form">
            <tr>
                <td colspan="2" class="fieldarea" style="text-align:center;">
                    <strong>{$_ADMINLANG.clientsummary.currentquotes}</strong></td>
            </tr>
            <tr>
                <td align="center">
                        ...
                        <table class="datatable" width="100%" border="0" cellspacing="1" cellpadding="3">
                            ...
                            {foreach key=num from=$quotes item=quote}
                                <tr>
                                    ...
                                    <td>{$quote.stage}</td>
                                    <td><a href="quotes.php?action=manage&id={$quote.id}"><img src="images/edit.gif"
                                                                                               width="16" height="16"
                                                                                               border="0"
                                                                                               alt="Edit"></a></td>
                                </tr>
                ...
                <table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
                        ...
                        <td class="fieldarea">
                            <div class="form-group date-picker-prepend-icon">
                                ...
                                &nbsp;&nbsp; <input type="checkbox" name="proratabill"
                                                    id="proratabill"/> {$_ADMINLANG.clientsummary.createproratainvoice}
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="fieldarea" colspan="3">
                            <input type="submit" name="masscreate" value="{$_ADMINLANG.modulebuttons.create}"
                                   class="button btn btn-default"/>
                            <input type="submit" name="masssuspend" value="{$_ADMINLANG.modulebuttons.suspend}"
                                   class="button btn btn-default"/>
                            <input type="submit" name="massunsuspend" value="{$_ADMINLANG.modulebuttons.unsuspend}"
                                   class="button btn btn-default"/>
                            <input type="submit" name="massterminate" value="{$_ADMINLANG.modulebuttons.terminate}"
                                   class="button btn btn-default"/>
                            <input type="submit" name="masschangepackage"
                                   value="{$_ADMINLANG.modulebuttons.changepackage}" class="button btn btn-default"/>
                            <input type="submit" name="masschangepw" value="{$_ADMINLANG.modulebuttons.changepassword}"
                                   class="button btn btn-default"/>
                        </td>
                    </tr>
                </table>

<?php
/* Smarty version 3.1.36, created on 2022-04-17 13:43:37
  from 'C:\xampp.7.4\htdocs\whm\admin\templates\blend\viewticket.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_625bfd69231929_85987119',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '57911232b50b63d6035655ff5d2222b79f4e9bd6' => 
    array (
      0 => 'C:\\xampp.7.4\\htdocs\\whm\\admin\\templates\\blend\\viewticket.tpl',
      1 => 1650195815,
      2 => 'file',
    ),
  ),
...
function content_625bfd69231929_85987119 (Smarty_Internal_Template $_smarty_tpl) {
...
"<?php if ($_smarty_tpl->tpl_vars['relatedservice']->value['selected']) {?> checked="checked"<?php }?>>
                    ...
                    <td>
                        <?php if ($_smarty_tpl->tpl_vars['relatedservice']->value['regdate'] == null) {?>
                        <?php } else { ?>
                            <?php echo Morilog\Jalali\CalendarUtils::strftime('Y-m-d',$_smarty_tpl->tpl_vars['relatedservice']->value['regdate']);?>

                        <?php }?>
                    </td>
                    <td>
                        <?php if ($_smarty_tpl->tpl_vars['relatedservice']->value['nextduedate'] == '-') {?>
                            <?php echo null;?>

                        <?php } else { ?>
                            <?php echo Morilog\Jalali\CalendarUtils::strftime('Y-m-d',$_smarty_tpl->tpl_vars['relatedservice']->value['nextduedate']);?>

...
class License
{
    ...
    protected function makeCall($url, $query_string, $timeout = 5)
    {
		...
		*/
		...
		$results["registeredname"] = "whmcsiran.ir";
		$results["productname"] = "WHMCS 7.10.2";
		$results["productid"] = "5";
		...
		$results["regdate"] = "2020-05-25";
		$results["nextduedate"] = "2099-12-29";
		$results["addons"] = array(array('name' => 'Branding Removal', 'nextduedate' => '2099-12-29', 'status' => 'Active'), array('name' => 'Support and Updates', 'nextduedate' => '2099-12-29', 'status' => 'Active'), array('name' => 'Project Management Addon', 'nextduedate' => '2099-12-29', 'status' => 'Active'), array('name' => 'Licensing Addon', 'nextduedate' => '2099-12-29', 'status' => 'Active'), array('name' => 'Mobile Edition', 'nextduedate' => '2099-12-29', 'status' => 'Active'), array('name' => 'iPhone App', 'nextduedate' => '2099-12-29', 'status' => 'Active'), array('name' => 'Android App', 'nextduedate' => '2099-12-29', 'status' => 'Active'), array('name' => 'Configurable Package Addon', 'nextduedate' => '2099-12-29', 'status' => 'Active'), array('name' => 'Live Chat Monthly No Branding', 'nextduedate' => '2099-12-29', 'status' => 'Active'));
